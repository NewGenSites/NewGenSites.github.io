...
const translations = {
  es: {
    ...
    "nav.dropdown.packages.desc": "Básico, Serious Business Owner, The Perfectionist/Premium.",
    ...
    "packages.growth.demo": "Ver demo Serious Business Owner",
    ...
    "packages.premium.demo": "Ver demo The Perfectionist/Premium",
    ...
    "work.basic.description": "Demo Básico: Un sitio limpio de una sola página diseñado para poner tu negocio en línea rápido. Perfecto para landing pages sencillas o portafolios mínimos.",
    "work.basic.open": "Abrir Básico",
    "work.growth.title": "Demo Serious Business Owner • Harbor & Coast Outfitters",
    "work.growth.subtitle": "Tres páginas + grid de productos. Como una marca real de e-commerce.",
    "work.growth.description": "Demo Growth: Un sitio multipágina que le da espacio a tu negocio para crecer. Incluye páginas dedicadas para servicios y contacto, ofreciendo más profundidad que una página única.",
    "work.growth.open": "Abrir Growth",
    "work.growth.services": "Página de servicios",
    "work.growth.contact": "Página de contacto",
    "work.premium.title": "Demo The Perfectionist/Premium • Lumen Creative Studio",
    "work.premium.subtitle": "Seis páginas. Casos de estudio. Estructura de precios. Sensación de plataforma.",
    "work.premium.description": "Demo Premium: Un sitio multipágina completo y profesional pensado para marcas establecidas. Incluye páginas de servicios, trabajo/portafolio, sobre nosotros, precios y contacto: todo lo necesario para una presencia online completa.",
    ...
    "demo.growth.shop.item7.kicker": "Rompevientos",
    "demo.growth.shop.item7.title": "Jetty Spray Shell",
    "demo.growth.shop.item8.kicker": "Shorts",
    "demo.growth.shop.item8.title": "Harbor Walk Shorts",
    "demo.growth.shop.item9.kicker": "Bolso",
    "demo.growth.shop.item9.title": "Boardwalk Weekender",
    "demo.growth.shop.item10.kicker": "Sandalias",
    "demo.growth.shop.item10.title": "Low Tide Slides",
